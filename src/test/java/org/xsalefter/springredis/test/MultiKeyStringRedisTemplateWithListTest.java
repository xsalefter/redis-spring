...
/**
 * Multi key example using {@link String} as a key and {@link List} as a value.
 * @author xsalefter (xsalefter@gmail.com)
 */
@ContextConfiguration({"classpath*:/META-INF/spring-redis-config.xml"})
@RunWith(SpringJUnit4ClassRunner.class)
public class MultiKeyStringRedisTemplateWithListTest {
	...
	public void before() {
		...
		this.storage.rightPush("country", "Indonesia");
		this.storage.rightPush("country", "United States of America");
		this.storage.rightPush("country", "Canada");
	}
	...
	public void after() {
		...
		this.storage.getOperations().delete("country");
	}
	...
	@Test
	public void countAllCountry() {
		System.out.println(">>>>> countAllCountry() <<<<<");
		Long size = this.storage.size("country");
		Assert.assertEquals(size, Long.valueOf(3L));
	}
